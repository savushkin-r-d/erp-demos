...
namespace API.DTO
{
    public class SttnDTO : EntityBaseDTO, IMapWith<SttnDTO>
    {
        ...
        public decimal? NUK { get; set; }

        public decimal? VCENA { get; set; }

        public decimal? VSUMP { get; set; }

        public decimal? VSUMNDS { get; set; }

        public void Mapping(Profile profile)
        {
            profile.CreateMap<Sttn, SttnDTO>();
            profile.CreateMap<SttnDTO, Sttn>();
        }
    }
}